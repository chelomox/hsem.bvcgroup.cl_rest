...
$service->run();
 * @endcode
 * wlRestService class instantiation has to be done inside the endpoint PHP script file without other outputs generated.<br/>
 * @author WiseLoop
 */
class wlRestService {
    ...
    /**
     * @var string the extension of the default output handler
     */
    ...
    public function registerController($restController) {
        ...
        $this->_registeredControllers[strtolower($restController->getName() . '/' . $restController->getVersion())] = $restController;
    }
    ...
    public function run() {
        ...
        $key = strtolower($controllerName . '/' . $controllerVersion);
