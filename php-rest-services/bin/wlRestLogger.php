 ...
 * If provided to the REST service, this class will log all the errors and warnings occurred.
 * @code
//...
...
class wlRestLogger extends wlLogger {
     ...
     * @param string $dir the the directory path where the log file will be stored
     */
