 ...
 * Of course, the developer can implement any kind of validation logic and key generation procedure as the key does not have to be provided necessary by the <i>rest-settings.ini</i> file.
 * This trigger is designed just to provide a sample but it can be used as it is.<br/>
