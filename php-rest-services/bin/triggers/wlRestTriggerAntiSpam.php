 ...
 * This class implements a trigger that will protect the service against abusive usage limiting the number of requests per unit of time comming from the same IP address.
