 ...
 */
abstract class Comuna implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ComunaTableMap';
    ...
    /**
     * The value for the comu_codigo field.
     *
     * @var        int
     */
    protected $comu_codigo;

    /**
     * The value for the comu_nombre field.
     *
     * @var        string
     */
    protected $comu_nombre;

    /**
     * The value for the comu_c_provincia field.
     *
     * @var        int
     */
    protected $comu_c_provincia;

    /**
     * The value for the comu_r_fecha_creacion field.
     *
     * @var        DateTime
     */
    protected $comu_r_fecha_creacion;

    /**
     * The value for the comu_r_fecha_modificacion field.
     *
     * @var        DateTime
     */
    protected $comu_r_fecha_modificacion;

    /**
     * The value for the comu_r_usuario field.
     *
     * Note: this column has a database default value of: 1
     * @var        int
     */
    protected $comu_r_usuario;
    ...
    {
        $this->comu_r_usuario = 1;
    }

    /**
     * Initializes internal state of Base\Comuna object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Comuna</code> instance.  If
     * <code>obj</code> is an instance of <code>Comuna</code>, delegates to
     * <code>equals(Comuna)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Comuna The current object, for fluid interface
     */
    ...
    /**
     * Get the [comu_codigo] column value.
     *
     * @return int
     */
    public function getComuCodigo()
    {
        return $this->comu_codigo;
    }

    /**
     * Get the [comu_nombre] column value.
     *
     * @return string
     */
    public function getComuNombre()
    {
        return $this->comu_nombre;
    }

    /**
     * Get the [comu_c_provincia] column value.
     *
     * @return int
     */
    public function getComuCProvincia()
    {
        return $this->comu_c_provincia;
    }

    /**
     * Get the [optionally formatted] temporal [comu_r_fecha_creacion] column value.
     *
     *
     ...
     */
    public function getComuRFechaCreacion($format = NULL)
    {
        if ($format === null) {
            return $this->comu_r_fecha_creacion;
        } else {
            return $this->comu_r_fecha_creacion instanceof \DateTimeInterface ? $this->comu_r_fecha_creacion->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [comu_r_fecha_modificacion] column value.
     *
     *
     * @param      string|null $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getComuRFechaModificacion($format = NULL)
    {
        if ($format === null) {
            return $this->comu_r_fecha_modificacion;
        } else {
            return $this->comu_r_fecha_modificacion instanceof \DateTimeInterface ? $this->comu_r_fecha_modificacion->format($format) : null;
        }
    }

    /**
     * Get the [comu_r_usuario] column value.
     *
     * @return int
     */
    public function getComuRUsuario()
    {
        return $this->comu_r_usuario;
    }

    /**
     * Set the value of [comu_codigo] column.
     *
     * @param int $v new value
     * @return $this|\Comuna The current object (for fluent API support)
     */
    public function setComuCodigo($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->comu_codigo !== $v) {
            $this->comu_codigo = $v;
            $this->modifiedColumns[ComunaTableMap::COL_COMU_CODIGO] = true;
        }
    ...
    /**
     * Set the value of [comu_nombre] column.
     *
     * @param string $v new value
     * @return $this|\Comuna The current object (for fluent API support)
     */
    public function setComuNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->comu_nombre !== $v) {
            $this->comu_nombre = $v;
            $this->modifiedColumns[ComunaTableMap::COL_COMU_NOMBRE] = true;
        }
    ...
    /**
     * Set the value of [comu_c_provincia] column.
     *
     * @param int $v new value
     * @return $this|\Comuna The current object (for fluent API support)
     */
    public function setComuCProvincia($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->comu_c_provincia !== $v) {
            $this->comu_c_provincia = $v;
            $this->modifiedColumns[ComunaTableMap::COL_COMU_C_PROVINCIA] = true;
        }

        if ($this->aProvincia !== null && $this->aProvincia->getProvCodigo() !== $v) {
    ...
    /**
     * Sets the value of [comu_r_fecha_creacion] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Comuna The current object (for fluent API support)
     */
    public function setComuRFechaCreacion($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->comu_r_fecha_creacion !== null || $dt !== null) {
            if ($this->comu_r_fecha_creacion === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->comu_r_fecha_creacion->format("Y-m-d H:i:s.u")) {
                $this->comu_r_fecha_creacion = $dt === null ? null : clone $dt;
                $this->modifiedColumns[ComunaTableMap::COL_COMU_R_FECHA_CREACION] = true;
            }
        } // if either are not null

        return $this;
    } // setComuRFechaCreacion()

    /**
     * Sets the value of [comu_r_fecha_modificacion] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Comuna The current object (for fluent API support)
     */
    public function setComuRFechaModificacion($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->comu_r_fecha_modificacion !== null || $dt !== null) {
            if ($this->comu_r_fecha_modificacion === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->comu_r_fecha_modificacion->format("Y-m-d H:i:s.u")) {
                $this->comu_r_fecha_modificacion = $dt === null ? null : clone $dt;
                $this->modifiedColumns[ComunaTableMap::COL_COMU_R_FECHA_MODIFICACION] = true;
            }
        } // if either are not null

        return $this;
    } // setComuRFechaModificacion()

    /**
     * Set the value of [comu_r_usuario] column.
     *
     * @param int $v new value
     * @return $this|\Comuna The current object (for fluent API support)
     */
    public function setComuRUsuario($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->comu_r_usuario !== $v) {
            $this->comu_r_usuario = $v;
            $this->modifiedColumns[ComunaTableMap::COL_COMU_R_USUARIO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ComunaTableMap::translateFieldName('ComuCodigo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comu_codigo = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ComunaTableMap::translateFieldName('ComuNombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comu_nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ComunaTableMap::translateFieldName('ComuCProvincia', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comu_c_provincia = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ComunaTableMap::translateFieldName('ComuRFechaCreacion', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->comu_r_fecha_creacion = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ComunaTableMap::translateFieldName('ComuRFechaModificacion', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->comu_r_fecha_modificacion = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ComunaTableMap::translateFieldName('ComuRUsuario', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comu_r_usuario = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = ComunaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Comuna'), 0, $e);
        }
    }
    ...
    {
        if ($this->aProvincia !== null && $this->comu_c_provincia !== $this->aProvincia->getProvCodigo()) {
            $this->aProvincia = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildComunaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Comuna::setDeleted()
     * @see Comuna::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildComunaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ComunaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_CODIGO)) {
            $modifiedColumns[':p' . $index++]  = 'comu_codigo';
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'comu_nombre';
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_C_PROVINCIA)) {
            $modifiedColumns[':p' . $index++]  = 'comu_c_provincia';
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_R_FECHA_CREACION)) {
            $modifiedColumns[':p' . $index++]  = 'comu_r_fecha_creacion';
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_R_FECHA_MODIFICACION)) {
            $modifiedColumns[':p' . $index++]  = 'comu_r_fecha_modificacion';
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_R_USUARIO)) {
            $modifiedColumns[':p' . $index++]  = 'comu_r_usuario';
        }

        $sql = sprintf(
            'INSERT INTO comuna (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'comu_codigo':
                        $stmt->bindValue($identifier, $this->comu_codigo, PDO::PARAM_INT);
                        break;
                    case 'comu_nombre':
                        $stmt->bindValue($identifier, $this->comu_nombre, PDO::PARAM_STR);
                        break;
                    case 'comu_c_provincia':
                        $stmt->bindValue($identifier, $this->comu_c_provincia, PDO::PARAM_INT);
                        break;
                    case 'comu_r_fecha_creacion':
                        $stmt->bindValue($identifier, $this->comu_r_fecha_creacion ? $this->comu_r_fecha_creacion->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'comu_r_fecha_modificacion':
                        $stmt->bindValue($identifier, $this->comu_r_fecha_modificacion ? $this->comu_r_fecha_modificacion->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'comu_r_usuario':
                        $stmt->bindValue($identifier, $this->comu_r_usuario, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = ComunaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getComuCodigo();
                break;
            case 1:
                return $this->getComuNombre();
                break;
            case 2:
                return $this->getComuCProvincia();
                break;
            case 3:
                return $this->getComuRFechaCreacion();
                break;
            case 4:
                return $this->getComuRFechaModificacion();
                break;
            case 5:
                return $this->getComuRUsuario();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Comuna'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Comuna'][$this->hashCode()] = true;
        $keys = ComunaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getComuCodigo(),
            $keys[1] => $this->getComuNombre(),
            $keys[2] => $this->getComuCProvincia(),
            $keys[3] => $this->getComuRFechaCreacion(),
            $keys[4] => $this->getComuRFechaModificacion(),
            $keys[5] => $this->getComuRUsuario(),
        );
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aProvincia) {
                ...
                $result[$key] = $this->aProvincia->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setComuCodigo($value);
                break;
            case 1:
                $this->setComuNombre($value);
                break;
            case 2:
                $this->setComuCProvincia($value);
                break;
            case 3:
                $this->setComuRFechaCreacion($value);
                break;
            case 4:
                $this->setComuRFechaModificacion($value);
                break;
            case 5:
                $this->setComuRUsuario($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setComuCodigo($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setComuNombre($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setComuCProvincia($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setComuRFechaCreacion($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setComuRFechaModificacion($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setComuRUsuario($arr[$keys[5]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_CODIGO)) {
            $criteria->add(ComunaTableMap::COL_COMU_CODIGO, $this->comu_codigo);
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_NOMBRE)) {
            $criteria->add(ComunaTableMap::COL_COMU_NOMBRE, $this->comu_nombre);
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_C_PROVINCIA)) {
            $criteria->add(ComunaTableMap::COL_COMU_C_PROVINCIA, $this->comu_c_provincia);
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_R_FECHA_CREACION)) {
            $criteria->add(ComunaTableMap::COL_COMU_R_FECHA_CREACION, $this->comu_r_fecha_creacion);
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_R_FECHA_MODIFICACION)) {
            $criteria->add(ComunaTableMap::COL_COMU_R_FECHA_MODIFICACION, $this->comu_r_fecha_modificacion);
        }
        if ($this->isColumnModified(ComunaTableMap::COL_COMU_R_USUARIO)) {
            $criteria->add(ComunaTableMap::COL_COMU_R_USUARIO, $this->comu_r_usuario);
        }
    ...
    {
        $criteria = ChildComunaQuery::create();
        $criteria->add(ComunaTableMap::COL_COMU_CODIGO, $this->comu_codigo);
    ...
    {
        $validPk = null !== $this->getComuCodigo();
    ...
    /**
     * Generic method to set the primary key (comu_codigo column).
     *
    ...
    {
        return null === $this->getComuCodigo();
    }
    ...
    {
        $copyObj->setComuNombre($this->getComuNombre());
        $copyObj->setComuCProvincia($this->getComuCProvincia());
        $copyObj->setComuRFechaCreacion($this->getComuRFechaCreacion());
        $copyObj->setComuRFechaModificacion($this->getComuRFechaModificacion());
        $copyObj->setComuRUsuario($this->getComuRUsuario());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setComuCodigo(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    /**
     * Declares an association between this object and a ChildProvincia object.
     *
     * @param  ChildProvincia $v
     * @return $this|\Comuna The current object (for fluent API support)
     * @throws PropelException
     */
    public function setProvincia(ChildProvincia $v = null)
    {
        if ($v === null) {
            $this->setComuCProvincia(NULL);
        } else {
            $this->setComuCProvincia($v->getProvCodigo());
        }

        $this->aProvincia = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildProvincia object, it will not be re-added.
        if ($v !== null) {
            $v->addComuna($this);
        }
    ...
    /**
     * Get the associated ChildProvincia object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildProvincia The associated ChildProvincia object.
     * @throws PropelException
     */
    public function getProvincia(ConnectionInterface $con = null)
    {
        if ($this->aProvincia === null && ($this->comu_c_provincia != 0)) {
            $this->aProvincia = ChildProvinciaQuery::create()->findPk($this->comu_c_provincia, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProvincia->addComunas($this);
             */
        }
     ...
     * If this ChildComuna is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildComuna The current object (for fluent API support)
     */
    public function setDictacions(Collection $dictacions, ConnectionInterface $con = null)
    {
        ...
        foreach ($dictacionsToDelete as $dictacionRemoved) {
            $dictacionRemoved->setComuna(null);
        }
    ...
    public function setDireccions(Collection $direccions, ConnectionInterface $con = null)
    {
        ...
        foreach ($direccionsToDelete as $direccionRemoved) {
            $direccionRemoved->setComuna(null);
        }
    ...
    {
        if (null !== $this->aProvincia) {
            $this->aProvincia->removeComuna($this);
        }
        $this->comu_codigo = null;
        $this->comu_nombre = null;
        $this->comu_c_provincia = null;
        $this->comu_r_fecha_creacion = null;
        $this->comu_r_fecha_modificacion = null;
        $this->comu_r_usuario = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->applyDefaultValues();
        $this->resetModified();
    ...
    {
        return (string) $this->exportTo(ComunaTableMap::DEFAULT_STRING_FORMAT);
    }
